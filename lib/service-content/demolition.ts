    ...
    sections: [
      {
        ...
        paragraphs: [
          facts?.groundConditions
            ? `[Grounded Land Services](/) provides [professional demolition](/services/demolition) services in ${city}, Texas, helping homeowners, ranch owners, developers, and commercial property owners safely remove unwanted structures and prepare properties for their next phase of development. Ground conditions around ${city} are typically ${facts.groundConditions}, which our crews account for when planning excavation, debris removal, and site access for every demolition project. Whether you're tearing down an aging home, removing a barn, demolishing a concrete slab, clearing an abandoned mobile home, or preparing a site for new construction, our experienced team has the equipment and expertise to complete your project safely and efficiently.`
            : `[Grounded Land Services](/) provides [professional demolition](/services/demolition) services in ${city}, Texas, helping homeowners, ranch owners, developers, and commercial property owners safely remove unwanted structures and prepare properties for their next phase of development. Whether you're tearing down an aging home, removing a barn, demolishing a concrete slab, clearing an abandoned mobile home, or preparing a site for new construction, our experienced team has the equipment and expertise to complete your project safely and efficiently.`,
