      ...
      },
      {
        ...
        paragraphs: [
          facts?.groundConditions
            ? `[Grounded Land Services](/) provides [professional rock crushing](/services/rock-crushing) services in ${city}, Texas, helping homeowners, ranch owners, developers, and commercial property owners transform unusable rock into valuable material for future projects. Ground conditions around ${city} are typically ${facts.groundConditions}, meaning excavation often turns up plenty of rock — material our mobile crushers can process directly on-site instead of hauling away. Whether you're clearing a construction site, reclaiming agricultural land, building roads, preparing a homesite, or improving ranch infrastructure, our mobile rock crushing services eliminate the need to haul large quantities of rock off your property.`
